...
func newOrderQueueChan(size uint64) *orderQueueChan {
	size = roundUpNextPowerOfTwoOrderQueueChan(size)
	return &orderQueueChan{
...
func (c *orderQueueChan) Put(value *orderQueue) {
...
func (c *orderQueueChan) Read() *orderQueue {
