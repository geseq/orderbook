...
func newItemChanOrderPool(size uint64) *itemChanOrderPool {
	size = roundUpNextPowerOfTwoItemChanOrderPool(size)
	return &itemChanOrderPool{
		lastCommittedIndex: 0,
		nextFreeIndex:      0,
		readerIndex:        0,
		indexMask:          size - 1,
		contents:           make([]*Order, size),
	}
}

// Put writes a CacheItem to the front of the channel
func (c *itemChanOrderPool) Put(value *Order) {
...
func (c *itemChanOrderPool) Read() *Order {
...
// Empty the channel
func (c *itemChanOrderPool) Empty() {
