...
func newNodeTreeChan(size uint64) *nodeTreeChan {
	size = roundUpNextPowerOfTwoNodeTreeChan(size)
	return &nodeTreeChan{
...
func (c *nodeTreeChan) Put(value *nodeTree) {
...
func (c *nodeTreeChan) Read() *nodeTree {
